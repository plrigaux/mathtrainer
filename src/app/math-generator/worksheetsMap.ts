    ...
    constructor() {
        ...
        for (let i = 2; i <= 10; i++) {
            ...
            let workSheetItem = this.generateMapItem(
               `Add ${i}`,
                Worksheets2.additionTable,
                3,
                MathProblemTypes.ADDITION,
                {
                    problemTypes: MathProblemTypes.ADDITION,
                    numbers1: i.toString(),
                    numbers2: "",
                    shuffle: true
                }
            ...
            let workSheetItem2 = this.generateMapItem(
               `Sub ${i}`,
                Worksheets2.subtractionTable,
                3,
                MathProblemTypes.SUBTRACTION,
                {
                    problemTypes: MathProblemTypes.SUBTRACTION,
                    numbers1: i.toString(),
                    numbers2: `0-${i}`,
                    shuffle: true
                }
            )
            this.values.push(workSheetItem2);
        }
